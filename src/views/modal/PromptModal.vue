          ...
          <div class="ant-message-notice-content">
            <div class="ant-message-custom-content ant-message-warning">
              <i class="anticon anticon-exclamation-circle">
                <svg viewBox="64 64 896 896" data-icon="exclamation-circle" width="1em" height="1em" fill="currentColor">
        ...
        <div class="ant-message-notice">
          <div class="ant-message-notice-content">
            <div class="ant-message-custom-content ant-message-error">
              ...
              <span>默认3S消失，可自定义时长。不要超过15个字</span>
            </div>
          </div>
        </div>
      </span>
        ...
        <div class="ant-message-notice">
          <div class="ant-message-notice-content">
            <div class="ant-message-custom-content ant-message-info">
              <i class="anticon anticon-info-circle">
        ...
        <div class="ant-message-notice">
          <div class="ant-message-notice-content">
            <div class="ant-message-custom-content ant-message-success">
              ...
              <span>如需连接和描述，请改用通知提醒框</span></div>
          </div>
        </div>
      </span>
    </div>
...
export default {
  ...
  methods: {
    tenSeconds () {
      this.$message.success('这是成功的提示信息，它将在10秒内消失', 10)
    },
    loadingIcon () {
