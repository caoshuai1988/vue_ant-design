  ...
  <div class="main main-login1 main-login1-mountain">
    <div class="bgChoose">
      <ul>
        ...
        <li><router-link :to="{ name: 'login1Terrace'}" class="active">梯田</router-link></li>
      </ul>
    </div>
    <div class="login-box">
...
import imgSrc from '../../../assets/login_bg_terrace.jpg'
  ...
  .main {
    ...
    .login-box {
      ...
      &-left {
        ...
        width: 440px;
        height: 100%;
        background: url(~@/assets/login_left_terrace.jpg) center;
